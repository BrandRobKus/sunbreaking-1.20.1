...
public class BlazingHammerProjectileEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(BlazingHammerProjectileEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(BlazingHammerProjectileEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private ItemStack hammerStack = new ItemStack(ModItems.BLAZING_HAMMER);
    ...
    public BlazingHammerProjectileEntity(EntityType<? extends BlazingHammerProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.hammerStack = new ItemStack(ModItems.BLAZING_HAMMER);
    }

    public BlazingHammerProjectileEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.BLAZING_HAMMER_PROJECTILE, owner, world);
