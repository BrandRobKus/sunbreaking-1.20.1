...
public class HellbentHammerProjectileEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(HellbentHammerProjectileEntity.class, TrackedDataHandlerRegistry.BYTE);
    private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(HellbentHammerProjectileEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private ItemStack hammerStack = new ItemStack(ModItems.HELLBENT_HAMMER);
    ...
    public HellbentHammerProjectileEntity(EntityType<? extends HellbentHammerProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.hammerStack = new ItemStack(ModItems.HELLBENT_HAMMER);
    }

    public HellbentHammerProjectileEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.HELLBENT_HAMMER_PROJECTILE, owner, world);
