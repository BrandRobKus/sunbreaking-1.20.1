...
public class HammerProjectileRenderer extends EntityRenderer<HammerProjectileEntity> {
    ...
    @Override
    public void render(HammerProjectileEntity hammerEntity,
        ...
        this.itemRenderer.renderItem(hammerItem, net.minecraft.client.render.model.json.ModelTransformationMode.GROUND,
                light, OverlayTexture.DEFAULT_UV, matrixStack, vertexConsumers, hammerEntity.getWorld(), 0);
